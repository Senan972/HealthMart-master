                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="discount_price" class="form-control" required="" value="{{ $products -> discount_price }}"> </div>
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <a href="" class="btn-sm btn-danger" id="delete" title="Delete Data"><i class="fa fa-trash"></i></a>
                                        </h5>
                                        <p class="card-text">
                                            <div class="form-group">
