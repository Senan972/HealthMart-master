                    ...
                    <div class="table-responsive">
                        <form method="post" action="{{ route('subcategory.store') }}">
                            @csrf
                                ...
                                <div class="form-group">
                                    <h5><i class="fa-solid fa-pills"></i>Sub Category Urdu<span class="text-danger">*</span></h5>
                                    <div class="controls">
                                    <input type="text" name="subcategory_name_ur" class="form-control" value="{{ $subcategory -> subcategory_name_ur }}"> </div>
