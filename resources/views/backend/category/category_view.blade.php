                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('category.edit', $item -> id) }}" class="btn btn-info" title="Edit"><i class="fa fa-pencil"></i></a>
                        ...
                        <form method="post" action="{{ route('category.store') }}">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" name="category_name_ur" class="form-control"> </div>
