					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<div class="description-container m-t-20">
                                @if(session()->get('language') == 'urdu') {{ $product -> short_desc_ur }} @else {{ $product -> short_desc_en }} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                                            @if(session()->get('language') == 'urdu') {!! $product -> long_desc_ur !!} @else {!! $product -> long_desc_en !!} @endif
                                        </p>
									</div>	
								</div><!-- /.tab-pane -->
...
@if(session()->get('language') == 'urdu') {{ $product -> product_name_ur }} @else {{ $product -> product_name_en }} @endif
			...
			@else
			<div class="product-price">	
				<span class="price"> Rs. {{ $product->discount_price }} </span><span class="price-before-discount"> {{ $product->selling_price }} </span>
