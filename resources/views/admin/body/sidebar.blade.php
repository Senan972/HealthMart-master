      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{ ($prefix == '/category')? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'all.subcategory')? 'active':'' }}"><a href="{{ route('all.subcategory') }}"><i class="ti-more"></i>All Sub Categories</a></li>
            <li class="{{ ($route == 'all.childcategory')? 'active':'' }}"><a href="{{ route('all.childcategory') }}"><i class="ti-more"></i>All Child Categories</a></li>
